...
namespace Assets.Scripts.Char
{
    public class CharacterFactory : MonoBehaviour
    {
        ...
        //    {
        //        case "luciano":
        //            var luciano = Resources.Load("Prefabs/Luciano") as GameObject;
        //            character = Instantiate(luciano);
        //            return character;
        //        case "geran":
        //            var geran = Resources.Load("Prefabs/Geran") as GameObject;
        //            character = Instantiate(geran);
        //            return character;
        //        case "tomee":
        //            var tomee = Resources.Load("Prefabs/Tomee") as GameObject;
